...
(function () {
    ...
    var list = rows.map(function (r) {
      ...
      return '<div class="ordrow' + (isNow ? ' now' : '') + (done || !r.u.alive ? ' done' : '') + '">' +
        ...
        '<span class="who"><b style="color:' + (r.u.side === 0 ? 'var(--p1)' : 'var(--p2)') + '">' +
          (r.u.side === 0 ? '自軍' : '敵軍') + '</b> ' + r.u.def.name +
  ...
  function liveStatHTML(u) {
    ...
    return '<div class="livebox' + (u.side === 0 ? ' s0' : ' s1') + '">' +
      '<div class="lvhd"><b>' + (u.side === 0 ? '自軍' : '敵軍') + '</b>' +
  ...
  function renderBattle() {
    ...
    app.innerHTML =
      ...
      '<div class="orderline">' +
        ...
        '<span class="lg"><i class="d0"></i>自軍</span><span class="lg"><i class="d1"></i>敵軍</span>' +
      ...
      '<div class="field">' +
        ...
        '<div class="warline">' +
          ...
          '<div class="wl-mid"><span class="wl-arrow up">▲ 敵陣</span><span class="wl-tag">交 戦 ラ イ ン</span><span class="wl-arrow down">▼ 自陣</span></div>' +
  ...
  function step() {
    if (!S.st || S.st.phase === 'ended') return;

...
.mapwrap{flex:0 0 42svh;position:relative;overflow:hidden;background:#e6dfca;
...
function render(){
  ...
  if (RPGQ && n.entrance && n.kind === 'room'){
    ...
    else add('外へ出る──引き上げる', '依頼は未達。拾ったものは持ち帰れる', '', function(){
      exitDungeon();
    });
  }

...
function exitDungeon(){
  ...
  setTimeout(function(){
    ...
    try { parent.RPGDONE && parent.RPGDONE({ id: RPGQ.id, cleared: !!S.qdone,
      ...
      loot: S.loot || 0, sold: leftovers, bag: { salve: S.bag.salve || 0 },
...
function render(){
  ...
  if (!S.bag.salve && !S.loot && !dItems.length)
...
function begin(){
  ...
  verify(map);
  var carry = {};
  if (RPGQ && RPGQ.bag && RPGQ.bag.salve) carry.salve = RPGQ.bag.salve;   /* 街から持ち込んだ道具 */
